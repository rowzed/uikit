...
var Icon$u = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        ...
        React__default['default'].createElement("path", { d: "M61.5734 38.6718C61.5734 49.4575 48.3329 58.201 32 58.201C15.667 58.201 2.42651 49.4575 2.42651 38.6718C2.42651 27.8861 15.667 19.1426 32 19.1426C48.3329 19.1426 61.5734 27.8861 61.5734 38.6718Z", fill: "#fedbff" }),
...
var Icon$B = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React__default['default'].createElement("g", { clipPath: "url(#clip0)" },
            ...
            React__default['default'].createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "#3f48cc" }),
            React__default['default'].createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "#3f48cc" }),
            React__default['default'].createElement("g", { style: { mixBlendMode: "multiply" } },
                React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "#3f48cc" })),
            ...
            React__default['default'].createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "#3f48cc" }),
            React__default['default'].createElement("g", { style: { mixBlendMode: "multiply" } },
                React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "#3f48cc" }))),
        React__default['default'].createElement("defs", null,
...
var getThemeTextColor = function (_a) {
    ...
    return outline ? getColor$1(variant, theme) : "#e3b3e4";
};
...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #3f48cc, 0px 0px 0px 4px rgba(118, 69, 217, 0.6)",
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#fedbff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#e3b3e4", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#040c0a", textDisabled: "#BDC2C4", textSubtle: "#040c0a", borderColor: "#E9EAEB", card: "#e3b3e4", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#3f48cc", background: "#641565", backgroundDisabled: "#3c3742", contrast: "#e3b3e4", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#cecccc", textDisabled: "#666171", textSubtle: "#cecccc", borderColor: "#524B63", card: "#460947", gradients: {
